      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10">
        ...
        >
          ...
          <button
            disabled={loading}
            type="submit"
            className={`w-full bg-[#059669] text-white font-bold py-3 mt-2 rounded-xl shadow-lg shadow-[#064e3b]/20 text-[15px] flex items-center justify-center gap-2
              ${
                !loading
                  ? "hover:bg-[#047857] transition-all transform hover:-translate-y-0.5 active:scale-[0.99]"
